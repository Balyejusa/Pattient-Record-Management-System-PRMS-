...
label3=Label(frame2,text = " Welcome To The PATIENT RECORD MANAGEMENT SYSTEM (PRMS)" ,bg = "light blue", fg = "white", font = "Times 22 bold",)
...
def reply():
    ...
    if userid in lista3 and paswad in lista2:
        ...
        Bill_baton=Button(pageseven,text="Immunisation",width=12,font="Times 16",bg="red",fg="white",command=nowsarh)
        ...
        label.place(x=156,y=154)
        label=Label(pagethree,text="Patientaddress:",width=8,font="Times 16",bg="white",fg="blue")
        label.place(x=156,y=194)
        ...
        Baton=Button(pagethree,text="Balance:",width=10,font="Times 14",bg="white",fg="maroon",relief="raised",command=aliko)
        Baton.place(x=550,y=400)
        label=Label(pagethree,text="Received by:",width=10,font="Times 16",bg="white",fg="blue")
        label.place(x=550,y=154)
        Baton=Button(pagethree,text="Total:",width=10,font="Times 14",bg="white",fg="maroon",relief="raised",command=aliz)
        Baton.place(x=131,y=400)
        ...
        label=Label(pagesixt,text="Name of Patient:",width=9,font="Times 16",bg="white",fg="blue")
        label.place(x=246,y=139)
        ...
        label=Label(pagesixt,text="Name of Dentist:",width=9,font="Times 16",bg="white",fg="blue")
        label.place(x=246,y=389)
