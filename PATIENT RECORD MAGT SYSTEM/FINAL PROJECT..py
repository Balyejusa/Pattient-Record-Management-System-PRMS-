...
frame2=Frame(frame1,width=2000,height=80,bg="light blue")
...
label1.place(x=294,y=370)
label2 = Label(frame1,text = "User ID:" ,bg = "white", fg="blue", font = "Times 18 bold")
label2.place(x=310,y=300)

okbaton=PhotoImage(file="images1.png")
baton=Label(frame1,image=okbaton,height=210,bg="white",width=210)
baton.place(x=435,y=100)

label3=Label(frame2,text = " WELCOME TO THE PATIENT RECORD MANAGEMENT SYSTEM (PRMS)" ,bg = "light blue", fg = "white", font = "Times 25 bold",)
label3.place(x=71,y=20)


entry1=Entry(frame1,width=20,bg="white",fg="black",font="Times 18",relief="ridge",bd=4)
entry1.place(x=420,y=298)

entry2=Entry(frame1,width=17,bg="white",fg="black", font="Courier 18",show="*",relief="ridge",bd=4)
entry2.place(x=420,y=368)
...
def reply():
    ...
    if userid in lista3 and pasword in lista2:
        print("Welcome")
        def maxin(frame):
            frame.tkraise()
        ...
        frame2=Frame(create_frame,bg="light blue",width=1900,height=80)
        frame2.place(x=0,y=0)
        ...
        entral476=Entry(create_frame,width=14,font="Courier 15",bg="white",fg="black",show="*",relief="ridge",bd=3,textvariable=tce40)
        ...
        def reply1():
            try:
                ...
                try:
                    ...
                    lavd=Label(create_frame,text="Please enter your records in the spaces provided !",fg="red",bg="white",font="Times 13")
                    lavd.place(x=390,y=280)
            except sqlite3.IntegrityError:
                lavd=Label(create_frame,text="Sorry ID has already been taken \nby another user",fg="red",bg="white",font="Times 13")
                lavd.place(x=390,y=280)
        ...
        entr400=Entry(create_frame,width=14,font="Courier 15",bg="white",fg="black",show="*",relief="ridge",bd=3,textvariable=tvta22)
        ...
        frame2=Frame(pagesix,width=2000,height=80,bg="light blue")
        frame2.place(x=0,y=0)
        ...
        speed=StringVar()
        label4=Radiobutton(pagesix,text="Male",bg ="white",value="male",fg= "blue",font="Times 15",variable=speed)
        label4.place(x=150,y=330)

        check=Radiobutton(pagesix,text="Female",bg ="white",value="female",fg= "blue",font="Times 15",variable=speed)
        check.place(x=260,y=330)


        label2= Label(pagesix,text= "Occupation",bg= "white",fg= "blue",font= "Times 16")
        label2.place(x=480,y=330)
        ...
        def raw3():
            ...
            dept=tnt8.get()
            educ=tnt9.get()
            sql2=("UPDATE Staff SET Fname=?,Lname=?,nationality=?,mstatus=?,dob=?,resdnce=?,departmnt=?,Education=? WHERE workerid=?")
            c.execute(sql2,(fnem,lnem,nation,mstus,dodth,resd,dept,educ,waks))
            conn.commit()
        ...
        baton=Button(pagesix,text="Update",width=6,font="Times 13 bold",bg="white",fg="maroon",command=raw3)
        ...
        Inpatient_baton=Button(pageseven,text="In patient",width=12,font="Times 16 bold",bg="white",fg="blue",command=nowa)
        Inpatient_baton.place(x=250,y=200)
                                            ## INPATIENT ##
        ...
        def nowz():
            ...
            image141 = PhotoImage(file="waks.png")
            w = image141.width()
            h = image141.height()
            window.geometry("%dx%d+0+0" % (w, h))
            panel4 =Label(frameba, image=image141)
            panel4.place(x=0,y=120)

            panel4.image = image141
            ...
            baton=Button(frameba,text="Search",width=8,font="Times 12 bold",bg="white",fg="maroon",relief="groove",command=rund1)
            baton.place(x=709,y=80)
            
        Outpatient_baton=Button(pageseven,text="Out patient",width=12,font="Times 16 bold",bg="white",fg="blue",command=nowz)
        Outpatient_baton.place(x=250,y=280)
                                            ##OUTPATIENT##
        ...
        def nowzara():
            ...
            image142 = PhotoImage(file="waks.png")
            w = image142.width()
            h = image142.height()
            window.geometry("%dx%d+0+0" % (w, h))
            panel4 =Label(frameba, image=image142)
            panel4.place(x=0,y=120)

            panel4.image = image142
            ...
            baton=Button(frameba,text="Search",width=8,font="Times 12 bold",bg="white",fg="maroon",relief="groove",command=rund3)
            baton.place(x=709,y=80)

        Mangt_baton=Button(pageseven,text="Laboratory",width=12,font="Times 16 bold",bg="white",fg="blue",command=nowzara)
        Mangt_baton.place(x=250,y=360)
                                        ##LABORATORY##
        ...
        def nowzar():
            ...
            image143 = PhotoImage(file="waks.png")
            w = image143.width()
            h = image143.height()
            window.geometry("%dx%d+0+0" % (w, h))
            panel4 =Label(frameba, image=image143)
            panel4.place(x=0,y=120)

            panel4.image = image143
            
            baton=Button(frameba,text="Back",fg="white",bg="blue",font="Times 14",command=lambda:maxin(pageseven))
            baton.place(x=20,y=10)

            label=Label(frameba,text="Names",width=7,font="Times 16",bg="white",fg="black",relief="flat",bd=3)
            label.place(x=303,y=81)
            ...
            def rund2():
                try:
                    if entryv.get()=="":
                        ...
                        sqba=("SELECT * FROM Bills WHERE Patientname=?")
            ...
            def perform():
                ...
                text_entry.insert(INSERT,"\n\n\nPatient Name:"+"  "+roxyv[0])
                text_entry.insert(INSERT,"\n\n\nPatient Address:"+"  "+roxyv[1])
                text_entry.insert(INSERT,"\n\n\nDate of Bill"+"       ")
                text_entry.insert(INSERT,"Service details"+"      ")
                text_entry.insert(INSERT,"Total Billing Amount"+"   ")
                text_entry.insert(INSERT,"\n\n"+roxyv[7]+"           ")
                text_entry.insert(INSERT,"Consultation fee"+"         "+ctf1)
                text_entry.insert(INSERT,"\n\n"+"                    ")
                text_entry.insert(INSERT,"Medical fee"+"             "+ctf2)
                text_entry.insert(INSERT,"\n\n"+"                    ")
                text_entry.insert(INSERT,"Current fee"+"              "+ctf3)
                text_entry.insert(INSERT,"\n\n"+"                    ")
                text_entry.insert(INSERT,"Balance"+"                  "+ctf4)
                text_entry.insert(INSERT,"\n\n\n"+"        ")
                text_entry.insert(INSERT,"Total fee"+"              "+ctf5+"UGXshillings")
                text_entry.insert(INSERT,"\n\n\n\n\n\n\n"+"          ")
                text_entry.insert(INSERT,"Received by:"+"   "+roxyv[8])
            ...
            baton=Button(frameba,text="Search",width=8,font="Times 12 bold",bg="white",fg="maroon",relief="groove",command=rund2)
            baton.place(x=709,y=80)

            
        Room_baton=Button(pageseven,text="Bill",width=12,font="Times 16 bold",bg="white",fg="blue",command=nowzar)
        Room_baton.place(x=250,y=440)
                                        ##BILL##
        ...
        def nowsarh():
            ...
            baton=Button(frameba,text="Search",width=8,font="Times 12 bold",bg="white",fg="maroon",relief="groove",command=rund6)
            baton.place(x=709,y=80)


        
        Bill_baton=Button(pageseven,text="Immunisation",width=12,font="Times 16 bold",bg="white",fg="blue",command=nowsarh)
        Bill_baton.place(x=600,y=200)
                                        ##IMMUNISATION##
        ...
        Mortury_baton=Button(pageseven,text="Mortury",width=12,font="Times 16 bold",bg="white",fg="blue",command=nowsar)
        Mortury_baton.place(x=600,y=280)
                                        ##MORTURY##
        ...
        def nowzarar():
            ...
            image144 = PhotoImage(file="waks.png")
            w = image144.width()
            h = image144.height()
            window.geometry("%dx%d+0+0" % (w, h))
            panel4 =Label(frameba, image=image144)
            panel4.place(x=0,y=120)

            panel4.image = image144
            ...
            def rund6():
                try:
                    if entryvs.get()=="":
                        ...
                        sqba=("SELECT * FROM Dental WHERE Patientname=?")
            ...
            def perform():
                ...
                text_entry.grid(column=0, row=0)
                text_entry.insert(INSERT,"                                    ")
                text_entry.insert(INSERT,"Dental Report   ")
                text_entry.insert(INSERT,"\n\n\nName of Patient:"+"  "+roxyv[0]+"         ")
                text_entry.insert(INSERT,"Age:"+"   "+w)
                text_entry.insert(INSERT,"\n\nPatient Address:"+"  "+roxyv[2]+"          ")
                text_entry.insert(INSERT,"Incident:"+"   "+roxyv[3])
                text_entry.insert(INSERT,"\n\n\n\nSuggested Treatment"+"                       ")
                text_entry.insert(INSERT,"\n...........................................................................")
                text_entry.insert(INSERT,"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\...........................................................................")
                text_entry.insert(INSERT,"\n\n"+"                      ")
                text_entry.insert(INSERT,"Name of Supervisor Doctor"+"    "+roxyv[4])
        ...
        Dent_baton=Button(pageseven,text="Dental",width=12,font="Times 16 bold",bg="white",fg="blue",command=nowzarar)
        Dent_baton.place(x=600,y=360)
        ...
        def nowsark():
            ...
            def rund44():
                try:
                    if entrwki.get()=="":
                        ...
                        sqba=("SELECT * FROM Staff WHERE Fname=?")
                        c.execute(sqba,([entrwki.get()]))
                        rowsza =c.fetchall()
                        for roxyva in rowsza:
                            print(roxyva)
            ...
            baton=Button(frameb,text="Search",width=8,font="Times 12 bold",bg="white",fg="maroon",relief="groove",command=rund44)
            baton.place(x=709,y=80)
            
        Staff_baton=Button(pageseven,text="Staff",width=12,font="Times 16 bold",bg="white",fg="blue",command=nowsark)
        Staff_baton.place(x=600,y=440)
        ...
        label=Label(pagemor,text="Doctor's Name:",width=10,font="Times 16",bg="white",fg="blue")
        ...
        def raw3():
            ...
            postmotems=tcvt5.get()
            aged=tcvt6.get()
            sql2=("UPDATE Mortury SET Doctorname=?,patientid=?,DoD=?,Postmotem=?,Age=? WHERE Name=?")
            c.execute(sql2,(wakd,pated,dodeath,postmotems,aged,nem))
            conn.commit()
            tkinter.messagebox.askyesno("Warning","Details will be updated")
        ...
        baton.place(x=150,y=650)
        baton=Button(pagemor,text="Update",width=6,font="Times 13 bold",bg="white",fg="maroon",command=raw3)
        baton.place(x=450,y=650)
        ...
        ##inpatient
        frame14=Frame(pageone,bg="light blue",width=1900,height=80)
        ...
        speed=StringVar()
        label4=Radiobutton(pageone,text="Male",bg ="white",fg="blue",variable=speed,value="male",font="Times 15")
        label4.place(x=600,y=154)

        check=Radiobutton(pageone,text="Female",bg ="white",variable=speed,value="female",fg="blue",font="Times 15")
        ...
        def ruin():
            ...
            ntresd=txt43.get()
##            if entry117.get()=="" or entry127.get()=="" or entry37.get()=="" or entry47.get()=="" or entry57.get()=="" or entry67.get()=="" or entry77.get()=="" or entry87.get()=="" or entry97.get()=="" or entry107.get()=="" or entry197.get()=="" or entry167.get()=="" or entry137.get()=="":
##                print("Please enter the ID of the details you want to update")
##                label2= Label(pageone,text="Please enter the ID of the details you want to update",bg="white",fg="red",font= "Times 13")
##                label2.place(x=520,y=474)
        ...
        frame18=Frame(pagetwo,bg="light blue",width=1900,height=80)
        ...
        speed=StringVar()
        label4=Radiobutton(pagetwo,text="Male",bg ="white",variable=speed,value="male",fg="blue",font="Times 15")
        label4.place(x=600,y=154)

        check=Radiobutton(pagetwo,text="Female",bg ="white",variable=speed,value="female",fg="blue",font="Times 15")
        check.place(x=740,y=154)
        ...
        ##Bills
        frame14=Frame(pagethree,bg="light blue",width=1900,height=80)
        frame14.place(x=0,y=0)
        ...
        entr667.place(x=529,y=450)
        entr767=Entry(pagethree,width=17,font="Times 15",bg="white",fg="black",relief="ridge",bd=3,textvariable=tx16)
        entr767.place(x=529,y=410)
        entr867=Entry(pagethree,width=17,font="Times 15",bg="white",fg="black",relief="ridge",bd=3,textvariable=tx17)
        entr867.place(x=680,y=194)
        entr967=Entry(pagethree,width=17,font="Times 15",bg="white",fg="black",relief="ridge",bd=3,textvariable=tx18)
        entr967.place(x=680,y=154)

        def aliz():
            Total=int(entr367.get())+int(entr467.get())
            print(Total)
            entr767.insert(END,Total)
            aa=int(entr767.get())
            bb=int(entr567.get())
            balnce=aa-bb
            print(balnce)
            entr667.insert(END,balnce)
            

        

        label=Label(pagethree,text="Patientname:",width=8,font="Times 16",bg="white",fg="blue")
        label.place(x=156,y=154)
        label=Label(pagethree,text="Patientaddress:",width=12,font="Times 16",bg="white",fg="blue")
        label.place(x=108,y=194)
        label=Label(pagethree,text="Consultation Fee:",width=14,font="Times 16",bg="white",fg="blue")
        label.place(x=85,y=234)
        ...
        label.place(x=135,y=314)

##        
            
        Baton=Label(pagethree,text="Balance:",width=10,font="Times 14",bg="white",fg="blue")
        Baton.place(x=380,y=450)
        Baton=Label(pagethree,text="Total:",width=10,font="Times 14",bg="white",fg="blue")
        Baton.place(x=380,y=410)
        label=Label(pagethree,text="Received by:",width=10,font="Times 16",bg="white",fg="blue")
        label.place(x=550,y=154)
        Baton=Button(pagethree,text="Compute",width=10,font="Times 14",bg="white",fg="maroon",relief="raised",command=aliz)
        Baton.place(x=450,y=360)
        label=Label(pagethree,text="Date of payment:",width=15,font="Times 16",bg="white",fg="blue")
        label.place(x=480,y=194)
        ...
        def rep6():
            if entr167.get()=="" or entr269.get()=="" or entr367.get()=="" or entr467.get()=="" or entr567.get()=="" or entr667.get()=="" or entr767.get()=="" or entr867.get()==""or entr967.get()=="":
                print("Please enter all required details in the fields provided")
                label2= Label(pagethree,text="Please enter all required details \nin the fields provided",bg="white",fg="red",font= "Times 13")
                label2.place(x=420,y=444)
            else:
                patnem=tx10.get()
                patad=tx11.get()
                cfee=tx12.get()
                ...
                entr967.delete(0,END)

                sqz="INSERT INTO Bills(Patientname,Patientaddress,consutnfee,medicfee,currentpay,balance,total,dofpyment,receivedby) VALUES(?,?,?,?,?,?,?,?,?)"
                c.execute(sqz,(patnem,patad,cfee,mdfee,crntfee,bal,total,dofpt,recd))
                conn.commit()
        ...
        def raw3():
            ...
            recd=tx17.get()
            dofpt=tx18.get()
            sql2=("UPDATE Bills SET Patientaddress=?,consutnfee=?,medicfee=?,currentpay=?,balance=?,total=?,dofpyment=?,receivedby=? WHERE Patientname=?")
            c.execute(sql2,(patad,cfee,mdfee,crntfee,bal,total,recd,dofpt,patnem))
            conn.commit()
            tkinter.messagebox.askyesno("Warning","Details will be updated")

        def can():
            patnem=tx10.get()
            sw=("DELETE FROM Bills WHERE Patientname=?")
            c.execute(sw,[(patnem)])
            conn.commit()
            tkinter.messagebox.askyesno("Warning","Details will be Deleted")
        ...
        baton=Button(pagethree,text="Update",width=6,font="Times 13 bold",bg="white",fg="maroon",command=raw3)
        baton.place(x=450,y=650)
        ...
        label.place(x=243,y=199)
        label=Label(pagefour,text="Address:",width=10,font="Times 16",bg="white",fg="blue")
        label.place(x=234,y=244)
        label=Label(pagefour,text="Test Results:",width=10,font="Times 16",bg="white",fg="blue")
        label.place(x=234,y=334)

        speed=StringVar()
        label4=Radiobutton(pagefour,text="Inpatient",bg ="white",variable=speed,fg="blue",value="inpatient",font="Times 14 bold")
        label4.place(x=250,y=289)
        
        check=Radiobutton(pagefour,text="Outpatient",bg ="white",variable=speed,fg="blue",value="outpatient",font="Times 14 bold")
        check.place(x=440,y=289)
        ...
        def raw3():
                ...
                testr=txe12.get()
                tests=txe13.get()
                sql2=("UPDATE Labs SET age=?,address=?,tests=? WHERE names=?")
                c.execute(sql2,(patid,testr,tests,wakaid))
                conn.commit()
                tkinter.messagebox.askyesno("Warning","Details will be updated")
        ...
        baton.place(x=150,y=650)
        baton=Button(pagefour,text="Update",width=6,font="Times 13 bold",bg="white",fg="maroon",command=raw3)
        baton.place(x=450,y=650)
        ...
        label.place(x=153,y=214)
        label=Label(pagefive,text="Parent name:",width=15,font="Times 16",bg="white",fg="blue")
        label.place(x=145,y=334)
        label=Label(pagefive,text="Address:",width=13,font="Times 16",bg="white",fg="blue")
        label.place(x=550,y=154)
        label=Label(pagefive,text="Immunisation Against:",width=16,font="Times 16",bg="white",fg="blue")
        label.place(x=490,y=214)

        speed=StringVar()
        label4=Radiobutton(pagefive,text="Inpatient",bg ="white",variable=speed,fg="blue",value="inpatient",font="Times 14 bold")
        label4.place(x=145,y=274)
        
        check=Radiobutton(pagefive,text="Outpatient",bg ="white",variable=speed,fg="blue",value="outpatient",font="Times 14 bold")
        check.place(x=290,y=274)
...
##        check.place(x=290,y=274)
        ...
        def raw3():
                ...
                doctaz=txet13.get()
                fsd=txet14.get()
                sql2=("UPDATE Immune SET Age=?,Parentname=?,Address=?,disease=? WHERE names=?")
                c.execute(sql2,(patid,immagnst,doctaz,fsd,wakaid))
                conn.commit()
                tkinter.messagebox.askyesno("Warning","Details will be updated")
        ...
        baton.place(x=150,y=650)
        baton=Button(pagefive,text="Update",width=6,font="Times 13 bold",bg="white",fg="maroon",command=raw3)
        baton.place(x=450,y=650)
        ...
        frame16=Frame(pagesixt,bg="light blue",width=1900,height=80)
        frame16.place(x=0,y=0)
        ...
        label=Label(pagesixt,text="Name of Patient:",width=16,font="Times 16",bg="white",fg="blue")
        label.place(x=200,y=139)
        label=Label(pagesixt,text="Age:",width=8,font="Times 16",bg="white",fg="blue")
        label.place(x=243,y=189)
        label=Label(pagesixt,text="Address:",width=15,font="Times 16",bg="white",fg="blue")
        label.place(x=234,y=239)

        speed=StringVar()
        label4=Radiobutton(pagesixt,text="Inpatient",bg ="white",variable=speed,fg="blue",value="inpatient",font="Times 14 bold")
        label4.place(x=250,y=289)

        check=Radiobutton(pagesixt,text="Outpatient",bg ="white",variable=speed,fg="blue",value="outpatient",font="Times 14 bold")
        check.place(x=440,y=289)
        
        label=Label(pagesixt,text="Incident:",width=15,font="Times 16",bg="white",fg="blue")
        label.place(x=234,y=339)
        label=Label(pagesixt,text="Name of Dentist:",width=16,font="Times 16",bg="white",fg="blue")
        label.place(x=200,y=389)
        ...
        entry1023.place(x=405,y=139)
        entry1123=Entry(pagesixt,width=17,font="Times 15",bg="white",fg="black",relief="ridge",bd=3,textvariable=txeta11)
        entry1123.place(x=405,y=189)
        entry1223=Entry(pagesixt,width=17,font="Times 15",bg="white",fg="black",relief="ridge",bd=3,textvariable=txeta12)
        entry1223.place(x=405,y=239)
        entry1323=Entry(pagesixt,width=17,font="Times 15",bg="white",fg="black",relief="ridge",bd=3,textvariable=txeta13)
        entry1323.place(x=405,y=339)
        entry1423=Entry(pagesixt,width=17,font="Times 15",bg="white",fg="black",relief="ridge",bd=3,textvariable=txeta14)
        entry1423.place(x=405,y=389)
        def response():
            if entry1023.get()=="" or entry1123.get()=="" or entry1223.get()==""or entry1323.get()==""or entry1423.get()=="":
                print("Please enter all required details in the fields provided")
                label2= Label(pagesixt,text="Please enter all required details in the fields provided",bg="white",fg="red",font= "Times 13")
                label2.place(x=320,y=420)
            else:
                patnem=txeta10.get()
                age=txeta11.get()
                add=txeta12.get()
                ...
                entry1323.delete(0,END)
                entry1423.delete(0,END)
                
                sqf="INSERT INTO Dental(Patientname,Age,Address,Incident,Doctorname) VALUES(?,?,?,?,?)"
                c.execute(sqf,(patnem,age,add,inc,nemdoc))
                conn.commit()
        ...
        def raw3():
                ...
                inc=txeta13.get()
                nemdoc=txeta14.get()
                sql2=("UPDATE Dental SET Age=?,Address=?,Incident=?,Doctorname=? WHERE Patientname=?")
                c.execute(sql2,(age,add,inc,nemdoc,patnem))
                conn.commit()
                tkinter.messagebox.askyesno("Warning","Details will be updated")

        def can():
            patnem=txeta10.get()
            sw=("DELETE FROM Dental WHERE Patientname=?")
            c.execute(sw,[(patnem)])
            conn.commit()
            tkinter.messagebox.askyesno("Warning","Details will be Deleted")
        ...
        baton.place(x=150,y=650)
        baton=Button(pagesixt,text="Update",width=6,font="Times 13 bold",bg="white",fg="maroon",command=raw3)
        baton.place(x=450,y=650)
        baton=Button(pagesixt,text="Delete",width=6,font="Times 13 bold",bg="white",fg="maroon",command=can)
        baton.place(x=750,y=650)
...
def respond():
    root=Tk()
    root.geometry("2200x500")
    root.configure(bg="grey")
    root.title("Help")
    lab=Label(root,text="Welcome To The PATIENT RECORD MANAGEMENT SYSTEM\nWe thank you for chosing our application.\nThis application is developed to simplify your work during record taking.\nThe software technical developers studied at MUNI University in UGANDA and they include the following.\n1.EGARU FELIX\n2.BALYEJUSA MICHAEL\n3.ABOMUGISHA MOREEN\n4.AFEMA ALFRED\n5.DRAMANI ROPHINE\nThe software has the abilities of inserting and retrieving data,searching for individual registered person,making reports where necessary.\nHOW TO USE\nAfter getting the application and installing it on your device:\nput in the default password for either user or administrator\nThen you can perfom any operation you want and learn more",fg="blue",font="Times 15")
    lab.place(x=20,y=50)
        
button1=Button(frame1,text='Log In',width=22, bg= "white",fg="maroon",relief="raised",font="Times 14 bold",command=reply)
button1.place(x=420,y=440)
#message1=Message(frame1,text="Patient Record"+"\nManagement System",font="Times 14 italic",fg="blue",bg="white")
#message1.place(x=630,y=160)
